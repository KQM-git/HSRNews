...
- Adds Character Type filter for Upgrade Recommendation and Material Calculation functions in Game Tools. New character introduction feature added to Build Overview for the Upgrade Recommendation function.

- Game Tools now has the new Other Tools function, allowing Trailblazers to get to the wiki, Map, Battle Records, and other useful tools.

- Optimizes leveling material display sequence and Light Cone selection rules in the Material Calculation within Game Tools.
