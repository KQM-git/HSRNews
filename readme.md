...
# [Game Version 3.1 Optimization and Known Issues](archive/877.md)
...
- Fixes an issue where the descriptive texts for the buffs "Earth and Water" and "Bloodied Chiton" are incorrect when using the story trial character "Mydei (Destruction: Imaginary)" in battle. This fix does not affect actual effects.
